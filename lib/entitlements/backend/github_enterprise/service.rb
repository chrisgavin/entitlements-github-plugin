  ...
  class Backend
    class GitHubOrg
      class Service < Entitlements::Service::GitHub
        ...
        # Sync the members of an enterprise in a given role to match the member list.
        #
        # implementation - An Hash of { action: :add/:remove, person: <person DN> }
        # role           - A String with the role, matching a key of Entitlements::Backend::GitHubEnterprise::ENTERPRISE_ROLES.
        #
        ...
        # Upsert a user with a role to the enterprise.
        #
